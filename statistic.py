...
class StellarClient:
    ...
    def __init__(self, account_id,secret_key=None, controller=None):
    ...
    def get_signal(self, symbol: str): 
        ...
        data =pd.read_csv('ledger_candles.csv', index_col='timestamp', parse_dates=True)
...
# Example fetching live price and candle data
        ...
        print('balance',self.get_account_balance())

        candle_data = self.get_stellar_candles()
        print(f"Candle Data for {symbol_to_check}: {candle_data}")
...
if __name__ == "__main__":
    StellarClient(account_id=None,controller=None,secret_key='SBXATKQLVCHN4V5FKP5LSHG222ZV7ZRO47X4FBQUPWQ2AJ6EIMWKV2AN')#'SDYAPMSEK2N4LYRFROWHE4SK4LFXF2T2OMCU3BVDAJTEAYKHT4ESKOJ6'}
