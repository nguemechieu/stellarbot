...
class RiskManagement(Server):
    def __init__(self, controller, asset, risk_threshold, monitor_interval=60):
        """
    ...
    def _fetch_balance(self):
        ...
        """
        try:
            balance = self.controller.bot.get_balance(self.asset)
    ...
    def _fetch_total_balance(self):
        ...
        """
        try:
            total_balance =self.controller.bot.get_total_balance()  # Assuming this method exists
    ...
    def stop_monitoring(self):
        """
        Stops the monitoring process (typically used in multi-threaded or long-running processes).
        """
...
if __name__ == "__main__":
    # Assuming 'controller' is your bot controller object with the necessary methods
    QtCore.QCoreApplication.setApplicationName("StellarBot")
    app = QtCore.QCoreApplication([])
    RiskManagement( app,asset='USDC', risk_threshold=5.0)  # 5% risk threshold
