...
def add_section(layout, title, content):
...
def add_help_sections(layout):
    """Add the sections for help and support resources."""

    # 1. Getting Started
    add_section(layout, "Getting Started",
    ...
    # 2. Features Overview
    add_section(layout, "Features Overview",
    ...
    add_section(layout, "Troubleshooting",
    ...
    add_section(layout, "Understanding the Dashboard",
    ...
    # 5. Advanced Settings
    add_section(layout, "Advanced Settings",
